        ...
        onSlideChangeEnd: function () {
            ...
            switch (mySwiper.activeIndex) {
                ...
                case 6:
                    ...
                    $(".bm").on("tap", function () {
                        setTimeout(function () {
                            mySwiper.swipeTo(mySwiper.activeIndex + 1, 1);
                        }, 300);
                    })
                    break;
                case 7:
...
//		}
        ...
        if (textAuto) {
            ...
            setTimeout(function () {
                ...
                if (textX > ( zhudang.offset().left - 10 ) && textX < ( zhudang.offset().left + zhudang.width() - 10 )) {
                    ...
                    text.css({x: textX, y: 0, rotate: 0}).transition({y: (screenHeight + text.height() + 50), complete: function () {
                        textGo(text);
                    }}, textSpeed(), 'linear');
                }
            }, textTime);
    ...
    //提示翻屏
    function goNext() {
        $(".goNext").css({x: -15, opacity: 0}).transition({x: 0, opacity: 1, complete: function () {
            $(".goNext").transition({x: 15, opacity: 0, complete: function () {
